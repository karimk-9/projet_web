...
class Booking
{
    ...
    public function isBookableDates(){
        ...
        // comparaison de la date choisie avec les dates impossibles
    ...
    /**
     * Permet de récupérer un tableau des journées qui corrspondent à la réservation
     * @return array Un tableau représentant les jours de réservation
     */
