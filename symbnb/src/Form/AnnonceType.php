...
class AnnonceType extends AbstractType
{
    ...
    {
        $builder
            ->add('title', TextType::class, $this->getConfiguration("Titre","Tapez votre annonce"))
            ...
            ->add('rooms', IntegerType::class, $this->getConfiguration("Nombre de chambres","Nombre de chambres dispo"))
