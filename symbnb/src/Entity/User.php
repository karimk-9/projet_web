...
*@UniqueEntity(
*   fields={"email"}, 
*   message="Un utilisateur possèe déjà cette adresse e-mail."
*) 
 */
...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Votre introduction doit faire au moins 10caracères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Votre description doit faire au moins 100caracères")
     */
    private $description;
